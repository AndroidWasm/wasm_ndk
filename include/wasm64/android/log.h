...
inline int __android_log_print(int prio, const char* tag, const char* fmt, ...)
    __attribute__((__format__(printf, 3, 4))) { return 0; }
...
inline int __android_log_vprint(int prio, const char* tag, const char* fmt, va_list ap)
    __attribute__((__format__(printf, 3, 0))) { return 0; }
 ...
 * function.
 */
inline void __android_log_assert(const char* cond, const char* tag,
                                 const char* fmt, ...)
 ...
 */
inline int __android_log_buf_write(int bufID, int prio, const char* tag, const char* text) {
  return 0;
}
 ...
 */
inline int __android_log_buf_print(int bufID, int prio, const char* tag, const char* fmt, ...)
 ...
 */
inline void __android_log_write_log_message(struct __android_log_message* log_message) __INTRODUCED_IN(30) {}
 ...
 * Available since API level 30.
 */
inline void __android_log_set_logger(__android_logger_function logger) __INTRODUCED_IN(30) {}
 ...
 * Available since API level 30.
 */
inline void __android_log_logd_logger(const struct __android_log_message* log_message) __INTRODUCED_IN(30) {}
 ...
 * Available since API level 30.
 */
inline void __android_log_stderr_logger(const struct __android_log_message* log_message)
    __INTRODUCED_IN(30) {}
 ...
 * Available since API level 30.
 */
inline void __android_log_set_aborter(__android_aborter_function aborter) __INTRODUCED_IN(30) {}
 ...
 * Available since API level 30.
 */
inline void __android_log_call_aborter(const char* abort_message) __INTRODUCED_IN(30) {}
 ...
 * Available since API level 30.
 */
inline void __android_log_default_aborter(const char* abort_message)
 ...
 * Available since API level 30.
 */
inline int __android_log_is_loggable(int prio, const char* tag,
 ...
 * Available since API level 30.
 */
inline int __android_log_is_loggable_len(int prio, const char* tag, size_t len, int default_prio)
    __INTRODUCED_IN(30) { return 0; }
 ...
 * Available since API level 30.
 */
inline int32_t __android_log_set_minimum_priority(int32_t priority) __INTRODUCED_IN(30) { return 0; }
 ...
 * Available since API level 30.
 */
inline int32_t __android_log_get_minimum_priority(void) __INTRODUCED_IN(30) { return 0; }
 ...
 * Available since API level 30.
 */
inline void __android_log_set_default_tag(const char* tag) __INTRODUCED_IN(30) { }
