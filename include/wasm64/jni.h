...
struct _JNIEnv {
    ...
    jobject NewObject(jclass clazz, jmethodID methodID, Args... args) {
      return functions->NewObject(this, clazz, methodID, args...);
    }
...
#define CALL_TYPE_METHOD(_jtype, _jname)                                    \
    ...
    {                                                                       \
      return functions->Call##_jname##Method(this, obj, methodID, args...); \
    }
...
#define CALL_NONVIRT_TYPE_METHOD(_jtype, _jname)                            \
    ...
    _jtype CallNonvirtual##_jname##Method(jobject obj, jclass clazz,        \
        jmethodID methodID, Args... args)                                   \
    {                                                                       \
      return functions->CallNonvirtual##_jname##Method(this, obj,           \
                 clazz, methodID, args...);                                 \
    }
...
#define CALL_NONVIRT_TYPE(_jtype, _jname)                                   \
    ...
    void CallNonvirtualVoidMethod(jobject obj, jclass clazz,
        jmethodID methodID, Args... args)
    {
      functions->CallNonvirtualVoidMethod(this, obj, clazz, methodID, args...);
    }
...
#define CALL_STATIC_TYPE_METHOD(_jtype, _jname)                             \
    ...
    _jtype CallStatic##_jname##Method(jclass clazz, jmethodID methodID,     \
        Args... args)                                                       \
    {                                                                       \
      return functions->CallStatic##_jname##Method(                         \
...
#define CALL_STATIC_TYPE(_jtype, _jname)                                    \
    ...
    {
      functions->CallStaticVoidMethod(this, clazz, methodID, args...);
    }
