...
set(WASM_PLATFORM_SPECIFIC_INCLUDE_PATH "${CMAKE_CURRENT_LIST_DIR}/../../include/wasm64")
...
list(APPEND ANDROID_WASM_LINKER_FLAGS "-lc")
...
set(CMAKE_CXX_FLAGS "${ANDROID_WASM_COMPILER_FLAGS_CXX} ${ANDROID_WASM_COMPILER_FLAGS}")
